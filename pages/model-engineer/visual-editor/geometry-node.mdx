...
<Image
    ...
    alt="Geometry viewer in Model Engineer visual editor"
    width={700}
    height={20}
    style={{ margin: "auto" }}
/>
<figcaption style={{ textAlign: "center", fontSize: "0.7rem", marginBottom: "1rem" }}>
    Figure 2.: Geometry viewer in Model Engineer visual editor
</figcaption>

For data-driven problems, next version of Siml.ai Model Engineer will provide multiple methods for accessing data, 
